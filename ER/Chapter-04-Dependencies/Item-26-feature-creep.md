...
| Feature 统一 | [Item 25](./Item-25-dependency-graph.md) |
| `no_std` / `std` feature | [Item 33](../Chapter-06-Beyond-Standard-Rust/Item-33-no-std.md)（待补） |
| CI 测 feature 组合 | [Item 32](../Chapter-05-Tooling/Item-32-ci.md)（待补） |
| Clippy 否定性 feature 名 | [Item 29](../Chapter-05-Tooling/Item-29-clippy.md)（待补） |
...
- [ ] **`cargo-hack --feature-powerset`** + Item 32 CI 集成
- [ ] `[features]` 与 `docs.rs` `all-features` 文档构建
