...
foreach ($f in $files) {
    ...
    $c = $c -replace 'ER/ER-demos/item-05-06-newtype/', 'ER/Chapter-01-Types/Item-05-type-conversions/demo/'
    $c = $c -replace 'ER/ER-demos/item-03-option-result/', 'ER/Chapter-01-Types/Item-03-option-result-transforms/demo/'
    $c = $c -replace 'ER/ER-demos/item-04-error-types/', 'ER/Chapter-01-Types/Item-04-idiomatic-error-types/demo/'
    $c = $c -replace 'ER/ER-demos/item-04-core-error/', 'ER/Chapter-01-Types/Item-04-idiomatic-error-types/demo-core-error/'
    $c = $c -replace 'ER/ER-demos/item-15-borrow-checker/', 'ER/Chapter-03-Concepts/Item-15-borrow-checker/demo/'
    $c = $c -replace 'ER/ER-demos/item-16-miri/', 'ER/Chapter-03-Concepts/Item-16-avoid-unsafe/demo/'
    $c = $c -replace 'ER/ER-demos/item-18-dont-panic/', 'ER/Chapter-03-Concepts/Item-18-dont-panic/demo/'
    $c = $c -replace 'ER/ER-demos/item-20-tlv/', 'ER/Chapter-03-Concepts/Item-20-avoid-over-optimize/demo/'
    $c = $c -replace 'ER/ER-demos/item-22-visibility/', 'ER/Chapter-04-Dependencies/Item-22-minimize-visibility/demo/'
    $c = $c -replace 'ER/ER-demos/item-24-re-export/', 'ER/Chapter-04-Dependencies/Item-24-re-export-api-types/demo/'
    $c = $c -replace 'ER/ER-demos/item-26-feature-creep/', 'ER/Chapter-04-Dependencies/Item-26-feature-creep/demo/'
    $c = $c -replace 'ER/ER-demos/item-30-black-box/', 'ER/Chapter-05-Tooling/Item-30-beyond-unit-tests/demo/'
    $c = $c -replace 'ER/ER-demos/item-33-no-std/', 'ER/Chapter-06-Beyond-Standard-Rust/Item-33-no-std/demo/'
    $c = $c -replace 'ER/ER-demos/item-34-ffi-box/', 'ER/Chapter-06-Beyond-Standard-Rust/Item-34-ffi-boundaries/demo/'
    $c = $c -replace 'ER/ER-demos/item-35-bindgen/', 'ER/Chapter-06-Beyond-Standard-Rust/Item-35-bindgen/demo-bindgen/'
    $c = $c -replace 'ER/ER-demos/item-35-sys-workspace/', 'ER/Chapter-06-Beyond-Standard-Rust/Item-35-bindgen/demo-sys-workspace/'
