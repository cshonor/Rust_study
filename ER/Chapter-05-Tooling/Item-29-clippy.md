...
| `as` 与 cast lint | [Item 5](../Chapter-01-Types/Item-05-type-conversions.md) |
| 通配符导入 | [Item 23](../Chapter-04-Dependencies/Item-23-avoid-wildcard-imports.md) |
| feature 否定命名 | [Item 26](../Chapter-04-Dependencies/Item-26-feature-creep.md) |
| `Copy` / `.clone()` | [Item 10](../Chapter-02-Traits/Item-10-standard-traits.md) |
| CI `-Dwarnings` | [Item 32](./Item-32-ci.md)（待补） |
| 工具生态 | [Item 31](./Item-31-tooling-ecosystem.md)（待补） |
...
- [ ] 根目录 **`clippy.toml`**：`cognitive-complexity-threshold`、`too-many-arguments-threshold`
- [ ] GitHub Actions **`clippy-action`** 行内批注（Item 32）
