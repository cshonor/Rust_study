...
| doc test、examples | [Item 27](./Item-27-document-public-api.md)、[14.2](../../Book/14-cargo-crates/14.2-将crate发布到Crates.io.md) |
| 类型 vs 测试分工 | [Item 1](../Chapter-01-Types/Item-01-express-data-structures.md) |
| 测试里可 panic | [Item 18](../Chapter-03-Concepts/Item-18-dont-panic.md) |
| bench / black_box | [Item 20](../Chapter-03-Concepts/Item-20-avoid-over-optimize.md) |
| feature / cfg 穷举 | [Item 26](../Chapter-04-Dependencies/Item-26-feature-creep.md) |
| CI matrix | [Item 32](./Item-32-ci.md)（待补） |
...
- [ ] CI **matrix**：OS × Rust × features（Item 32）
- [ ] **`cargo-fuzz` corpus** 保存与共享
