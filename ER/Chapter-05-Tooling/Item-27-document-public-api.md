...
| 类型表达语义 | [Item 1](../Chapter-01-Types/Item-01-express-data-structures.md) |
| `# Panics` / 少 panic | [Item 18](../Chapter-03-Concepts/Item-18-dont-panic.md) |
| CI 集成 doc | [Item 32](./Item-32-ci.md)（待补） |
| 工具生态 | [Item 31](./Item-31-tooling-ecosystem.md)（待补） |
| 最小可见性 | [Item 22](../Chapter-04-Dependencies/Item-22-minimize-visibility.md) |
