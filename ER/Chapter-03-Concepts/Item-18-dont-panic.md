...
| 错误传播模式 | [Item 3](../Chapter-01-Types/Item-03-option-result-transforms.md) |
| FFI / panic 边界 | [Item 16](./Item-16-avoid-unsafe.md)、[Item 34](../Chapter-06-Beyond-Standard-Rust/Item-34-ffi-boundaries.md) |
| 锁中毒 | [Item 17](./Item-17-shared-state-parallelism.md) |
| `no_panic` + CI | [Item 32](../Chapter-05-Tooling/Item-32-ci.md)（待补） |
...
| **持锁 panic** | [锁中毒](./Item-17-shared-state-parallelism.md) — 另一路「panic 的代价」 |
