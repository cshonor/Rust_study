...
> 所属：Part III · [part03_clox](../README.md) · [本书目录](../../本书目录.md) · 上一章：[ch25 Closures](../chapter25_objects/25-closures.md)
...
**对照 ch20 [intern](../chapter20_hash-tables/20-hash-tables.md)**：性能优化与 GC **必须协同设计**。
