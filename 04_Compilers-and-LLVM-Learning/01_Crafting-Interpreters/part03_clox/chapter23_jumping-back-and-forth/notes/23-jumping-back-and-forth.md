...
> 所属：Part III · [part03_clox](../../README.md) · [本书目录](../../../本书目录.md) · 上一章：[ch22 Local Variables](../chapter22_local-variables/notes/22-local-variables.md)
...
**对照 jlox [ch9 §9.2](../../part02_jlox/chapter09_control-flow/notes/09-control-flow.md)**：悬挂 else 靠 Parser；clox 靠 **跳转布局 + 回填**。
