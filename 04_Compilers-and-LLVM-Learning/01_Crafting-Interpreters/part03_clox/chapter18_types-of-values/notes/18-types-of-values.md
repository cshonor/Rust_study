...
> 所属：Part III · [part03_clox](../../README.md) · [本书目录](../../../本书目录.md) · 上一章：[ch17 Compiling](../chapter17_compiling-expressions/notes/17-compiling-expressions.md)
...
**对照 jlox [ch7](../../part02_jlox/chapter07_evaluating-expressions/notes/07-evaluating-expressions.md)**：Java **`Object`** 装箱；clox **显式 tag**，无 GC 压力于小值。
...
**Lox 规则**（与 [ch3 规格](../../part01_welcome/chapter03_the-lox-language/notes/03-the-lox-language.md) 一致）：
