...
> 所属：Part III · [part03_clox](../README.md) · [本书目录](../../本书目录.md) · 上一章：[ch27 Classes](../chapter27_classes-and-instances/27-classes-and-instances.md)
...
**对照 jlox [ch12 §12.4](../../part02_jlox/chapter12_classes/12-classes.md)**：语义相同 · clox 后加 **invoke 融合优化**。
...
| 章 | 目录 | 内容 |
|:--:|------|------|
| **29** | [chapter29 · Superclasses](../chapter29_wrappers-and-api/29-superclasses.md) | **`OP_INHERIT`** · **`super`** |
