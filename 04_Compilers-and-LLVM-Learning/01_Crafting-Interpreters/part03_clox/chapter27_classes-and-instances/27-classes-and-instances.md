...
> 所属：Part III · [part03_clox](../README.md) · [本书目录](../../本书目录.md) · 上一章：[ch26 GC](../chapter26_garbage-collection/26-garbage-collection.md)
...
**对照 jlox [ch12 §12.2](../../part02_jlox/chapter12_classes/12-classes.md)**：类作 **callable 工厂**。
