...
> 所属：Part III · [part03_clox](../README.md) · [本书目录](../../本书目录.md) · 上一章：[ch23 Jumping](../chapter23_jumping-back-and-forth/23-jumping-back-and-forth.md)
...
| **闭包续** | 见 [ch25 Closures 笔记](../chapter25_objects/25-closures.md)（原书 §24.8+ Upvalue） |

---

## 闭包 / Upvalue（原书同章续）

完整梳理见 **[第 25 批 · Closures](../chapter25_objects/25-closures.md)**：`ObjUpvalue` · flattening · **`OP_CLOSE_UPVALUE`**。
...
§24.7   ObjNative · clock()
后续    [ch25 Closures](../chapter25_objects/25-closures.md)
```
...
| 章 / 节 | 内容 |
|---------|------|
| **ch24 续** | [ch25 · Closures](../chapter25_objects/25-closures.md) | **Upvalue** · **`OP_CLOSE_UPVALUE`** |
