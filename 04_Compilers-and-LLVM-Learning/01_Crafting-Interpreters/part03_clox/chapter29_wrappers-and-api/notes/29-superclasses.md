...
> 所属：Part III · [part03_clox](../../README.md) · [本书目录](../../../本书目录.md) · 上一章：[ch28 Methods](../chapter28_methods/notes/28-methods.md)
...
**对照 jlox [ch13](../../part02_jlox/chapter13_inheritance/notes/13-inheritance.md)**：运行时 **超类链查找** vs clox **表拷贝** —— 典型 **编译期换运行时** 优化。
