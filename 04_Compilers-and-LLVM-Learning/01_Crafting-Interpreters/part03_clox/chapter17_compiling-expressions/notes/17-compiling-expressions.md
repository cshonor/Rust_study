...
> 所属：Part III · [part03_clox](../../README.md) · [本书目录](../../../本书目录.md) · 上一章：[ch16 Scanning](../chapter16_scanning-on-demand/notes/16-scanning-on-demand.md)
...
**对照 jlox [ch6](../../part02_jlox/chapter06_parsing-expressions/notes/06-parsing-expressions.md)**：递归下降每层一个函数；Pratt 用 **表驱动 + 优先级** 统一处理运算符。
