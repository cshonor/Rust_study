...
> 所属：Part III · [part03_clox](../../README.md) · [本书目录](../../../本书目录.md) · 上一章：[ch20 Hash Tables](../chapter20_hash-tables/notes/20-hash-tables.md)
...
**对照 jlox [ch8](../../part02_jlox/chapter08_statements-and-state/notes/08-statements-and-state.md)**：表达式语句 Visitor 直接 **忽略返回值**；clox 显式 **POP**。
