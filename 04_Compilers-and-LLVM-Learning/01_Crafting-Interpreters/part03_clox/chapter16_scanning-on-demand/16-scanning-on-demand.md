...
> 所属：Part III · [part03_clox](../README.md) · [本书目录](../../本书目录.md) · 上一章：[ch15 VM](../chapter15_a-virtual-machine/15-a-virtual-machine.md)
...
**对照 jlox**：[ch04 Scanning](../../part02_jlox/chapter04_scanning/04-scanning.md) 的 **`Scanner.scanTokens()`** 一次扫完。
