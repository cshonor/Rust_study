...
> 所属：Part II · [part02_jlox](../README.md) · [本书目录](../../本书目录.md) · 上一章：[ch03 Lox 规格](../../part01_welcome/chapter03_the-lox-language/03-the-lox-language.md)

---

## 本章定位

**Part II 第一段代码**：实现 **jlox 扫描器（Scanner）**——编译/解释流水线的**第一站**（[ch02 §2.1.1](../../part01_welcome/chapter02_map-of-the-territory/02-map-of-the-territory.md)）。
