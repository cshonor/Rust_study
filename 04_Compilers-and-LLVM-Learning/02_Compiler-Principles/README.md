...
| **定位** | 现代编译器**工程向**教材：前端 → IR（含 SSA）→ 优化 → 代码生成；第三版加强语义 elaboration、命名/可寻址性、代码形状等 |
| **本目录** | [`本书目录.md`](./本书目录.md) · `chapter01_overview/` … |
...
- [x] ch1 编译总览笔记（一小节一 md）
- [ ] 添加「精读取舍」（类似 `04` 的 `Learn-LLVM-17-学习取舍.md`）
- [ ] 补全第三版章节目录
