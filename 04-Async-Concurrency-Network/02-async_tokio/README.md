...
> 所属：[04-Async-Concurrency-Network](../README.md) · **02/03** · 前置 [`01-atomic/`](../01-atomic/README-学习区.md) · 下一步 [`03-rust_network_programming/`](../03-rust_network_programming/README.md) stage07
...
```bash
cd 04-Async-Concurrency-Network/02-async_tokio/ch10_dependency_free_async_server/10.2-building-std-async-runtime
...
```bash
python 04-Async-Concurrency-Network/02-async_tokio/scripts/scaffold-missing-demos.py   # 为缺 demo 的小节建目录
python 04-Async-Concurrency-Network/02-async_tokio/scripts/update-index-demos.py       # 刷新各章索引表的 Demo 列
python 04-Async-Concurrency-Network/02-async_tokio/scripts/split_chapter_notes.py      # 旧笔记拆分（已对齐的章会自动 skip）
```
