...
> 所属：[04-Async-Concurrency-Network](../README.md) · 建议 **stage03 阻塞 Socket** 后再 **stage07 + async_tokio**

本目录为《Network Programming with Rust》的**结构化学习路线**，与同级的 `async_tokio/`、`atomic/` **互补**：侧重 **Socket 实战、IO 模型、协议与工程化网络**。
...
- **并发 / 原子 / 内存序**：见 [`../atomic/`](../atomic/README-学习区.md)（含 `rayon/` 子 crate）
- **异步 Rust / Tokio 概念**：见 [`../async_tokio/`](../async_tokio/README.md)
