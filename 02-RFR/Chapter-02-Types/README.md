...
| **2** | Traits and Trait Bounds | [05 编译与分发](./05-compilation-dispatch.md) · [06 泛型 Trait](./06-generic-traits.md) · [07 相干性与孤儿规则](./07-coherence-orphan-rule.md) · [orphan-rule-demo](./orphan-rule-demo/) · [08 Trait 限定](./08-trait-bounds.md) · [09 标记 Trait](./09-marker-traits.md) |
