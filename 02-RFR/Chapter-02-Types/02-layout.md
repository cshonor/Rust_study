...
| **`readelf` / `objdump` / LLVM IR** | 链接后类型、`*alloca` `align` → [04_Compilers-and-LLVM-Learning/04_Learn-LLVM-17 ch05](../../04_Compilers-and-LLVM-Learning/04_Learn-LLVM-17/part02_src_to_machine/chapter05_ir_advanced_type/README.md) |
