...
→ [05_Compilers-and-LLVM-Learning/04_Learn-LLVM-17 · ch04 分发 IR 对照](../../05_Compilers-and-LLVM-Learning/04_Learn-LLVM-17/part02_src_to_machine/chapter04_ir_basic/notes/04_dispatch_static_vs_dyn.md) · [04_dispatch_O0.ll](../../05_Compilers-and-LLVM-Learning/04_Learn-LLVM-17/ir_samples/optimize_compare/04_dispatch_O0.ll)
