...
**为何重要（HFT / 性能）**：安全 Rust 里写 `&T`，编译器能假定「这段期间没人改」— 不必每次读都当成可能 alias 的 wild pointer。读 IR 时见 [llvm_insight ch04](../../llvm_insight/part02_src_to_machine/chapter04_ir_basic/README.md)。
