...
| 编号 | 系列 | 核心 | 详例 | 速记 |
|------|------|------|------|------|
| **01-1** | **`as_`** | 只读借用，不消耗 | [01-1-as-series](./01-1-as-series.md) | [速记](./01-1-cheat-sheet.md) |
| **01-2** | **`into_`** | 所有权转移 | [01-2-into-series](./01-2-into-series.md) | [速记](./01-2-cheat-sheet.md) |
| **01-3** | **`get_`** | 安全访问，`Option` | [01-3-get-series](./01-3-get-series.md) | [速记](./01-3-cheat-sheet.md) |
| **01-4** | **`try_`** | 错误处理，`Result` | [01-4-try-series](./01-4-try-series.md) | [速记](./01-4-cheat-sheet.md) |
| **01-5** | **`with_`** | 建造者 / 构造配置 | [01-5-with-series](./01-5-with-series.md) | [速记](./01-5-cheat-sheet.md) |
...
→ 总速记：[01-cheat-sheet.md](./01-cheat-sheet.md) · 下一节：[02 通用 Trait](./02-common-traits-for-types.md)
