...
| 主节 | 英文 | 子节 / 笔记 |
|------|------|-------------|
| **1** | Unsurprising | [01 命名](./01-naming-practices.md)（[01-1~5 五系列](./01-1-as-series.md) · [demo](./naming-series-demo/) · 迭代器三巨头 · [01 速记](./01-cheat-sheet.md)）· [02 通用 Trait](./02-common-traits-for-types.md)（[02-1 完整解读](./02-1-common-traits-full-guide.md) · [02/02-1 速记](./02-cheat-sheet.md)）· [03 人体工程学 impl](./03-ergonomic-trait-implementations.md)（[03-1 Blanket 详例](./03-1-ergonomic-blanket-full-guide.md) · [demo](./blanket-trait-demo/)）· [04 包装类型](./04-wrapper-types.md) |
