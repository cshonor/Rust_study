...
| 主节 | 英文 | 子节 / 笔记 |
|------|------|-------------|
| **1** | Unsurprising | [01 命名](./01-naming-practices.md)（[01-2 as/into/get/try 详例](./01-2-as-into-get-try-examples.md) · [01-1 with/Builder](./01-1-with-series-and-builder.md) · 迭代器三巨头 · [01/01-1/01-2 速记](./01-cheat-sheet.md)）· [02 通用 Trait](./02-common-traits-for-types.md)（[02-1 完整解读](./02-1-common-traits-full-guide.md) · [02/02-1 速记](./02-cheat-sheet.md)）· [03 人体工程学 impl](./03-ergonomic-trait-implementations.md) · [04 包装类型](./04-wrapper-types.md) |
