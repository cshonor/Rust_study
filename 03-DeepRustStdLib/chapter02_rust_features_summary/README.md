...
**本章定位**（原书第 2 章，见 [本书目录 § 第 2 章](../本书目录.md#第-2-章--rust-特征小议p5)）：

| 原书节 | 主题 | 状态 |
|:---:|------|------|
| **2.1** | 泛型小议（2.1.1～2.1.2） | 📝 规划 |
| **2.2** | Rust 内存安全杂述 | 📝 规划 |
| **2.3** | 获取封装类型内部变量（2.3.1～2.3.5） | 📝 规划 |
| **2.4** | 回顾 | 📝 规划 |

下方 **2.1～2.7 为补充轨道**（RFR ↔ `std` 桥梁），待按原书 2.1～2.4 收敛或迁入附录。
